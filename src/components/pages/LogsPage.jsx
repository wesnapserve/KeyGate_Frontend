...
export default function LogsPage({ ctx }) {
  ...
  return <div className='page active'><div className='page-header'><div className='page-title'>Request logs</div><div className='page-sub'>Every request proxied through KeyGate</div></div>
