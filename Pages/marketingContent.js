...
export const PLANS = [
  ...
  {
    name: 'Starter',
    text: 'For small teams and indie developers.',
    price: '$12.99',
    cadence: '/month',
    note: '₹1,099 charged via Razorpay',
    features: [
      '3 Projects',
      '20 Subkeys',
      '2M Tokens / Month',
  ...
  {
    name: 'Pro',
    text: 'For growing AI products and startups.',
    price: '$39',
    cadence: '/month',
    note: '₹3,299 charged via Razorpay',
    features: [
      '10 Projects',
      '75 Subkeys',
      '20M Tokens / Month',
  ...
  {
    name: 'Scale',
    text: 'For high-volume AI products.',
    price: '$99',
    cadence: '/month',
    note: '₹8,499 charged via Razorpay',
    features: [
      { text: '*Unlimited Projects', tooltip: 'Subject to fair usage' },
      '500 Subkeys',
      '100M Tokens / Month',
      'Extended Logs',
      'Advanced Controls+',
